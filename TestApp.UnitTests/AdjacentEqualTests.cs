...
public class AdjacentEqualTests
{
    ...
    public void Test_Sum_NoAdjacentEqualNumbers_ShouldReturnOriginalList()
    {
        ...
        // Act
        string result = AdjacentEqual.Sum(list);        // Assert
    ...
    {
        // Arrange
        List<int> list = new() { 1, 2, 4, 4 };
        // Act
        string result = AdjacentEqual.Sum(list);
        // Assert
        Assert.That(result, Is.EqualTo("1 2 8"));
    }
    ...
    {
        // Arrange
        List<int> list = new() { 1, 2, 4, 4, 5, 6 };
        // Act
        string result = AdjacentEqual.Sum(list);
        // Assert
        Assert.That(result, Is.EqualTo("1 2 8 5 6"));
    }
}
